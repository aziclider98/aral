...
return [
    ...
    */
    ...
    "accepted_if"=> "The :attribute must be accepte:when :other is value.",
    "active_url"=> ":Attribute ga noto‘g‘ri URL kiritildi.",
    "after"=> ":Attribute d:sana :date dan keyin bo‘lishi kerak.",
    ...
    "between.array"=> ":Attribute dagi elementla:soni :min va :max orasida bo‘lishi kerak.",
    ...
    */
    ...
    'attributes' => [
        'name' => 'Ismingiz',
        'email' => 'Sizning elektron manzilingiz',
        'old_password' => 'Eski parol',
        'new_password' => 'Yangi Parol',
        'new_password_confirmation' => 'Yangi parolni tasdiqlang',
        'en_title' => 'Ingliz Yangilik sarlavhasi',
        'ru_title' => 'Rus Yangilik sarlavhasi',
        'uz_title' => 'O\'zbek Yangilik sarlavhasi',
        'qqr_title' => 'Qoraqalpoq Yangilik sarlavhasi',
        'en_text' => 'Ingliz Yangilik matni',
        'ru_text' => 'Rus Yangilik matni',
        'uz_text' => 'O\'zbek Yangilik matni',
        'qqr_text' => 'Qoraqalpoq Yangilik matni',
    ],
