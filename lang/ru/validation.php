...
return [
    ...
    */
    ...
    "between.file" => "Размер файла должен быть между :min и :max Килобайт(а).",
    ...
    "gt.file"=> "Размер файла должен быть больше :value Килобайт(а).",
    ...
    "gte.file"=> "Размер файла должен быть :value Килобайт(а) или больше.",
    ...
    "lt.file"=> "Размер файла должен быть меньше :value Килобайт(а).",
    ...
    "lte.file"=> "Размер файла должен быть :value Килобайт(а) или меньше.",
    "lte.numeric"=> "Значение должно быть :value или меньше.",
    ...
    "max.file"=> "Размер файла не может быть больше :max Килобайт(а).",
    ...
    "min.file"=> "Размер файла должен быть не меньше :min Килобайт(а).",
    ...
    "required"=> ":Attribute oбязательно для заполнения.",
    ...
    "size.file"=> "Размер файла должен быть равен :size Килобайт(а).",
    ...
    */
    ...
    'attributes' => [
        ...
        'en_title' => 'Английский Название новости',
        'ru_title' => 'Русский Название новости',
        'uz_title' => 'Узбекский Название новости',
        'qqr_title' => 'Каракалпакский Название новости',
        'en_text' => 'Английский Текст новости',
        'ru_text' => 'Русский Текст новости',
        'uz_text' => 'Узбекский Текст новости',
        'qqr_text' => 'Каракалпакский Текст новости',
    ],
